...
float findHighestPrice(PriceType, int, int); // returns the highest price in the array
float findLowestPrice(PriceType, int, int);	 // returns the lowest price in the array
...
int main()
{
	...
	cout << endl
		 << "The highest price is " << findHighestPrice(priceTable, rowsUsed, colsUsed) << endl;
